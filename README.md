...
**_Please note_**: At present a User would need to regenerate XRPL wallet credentials and add them to the ".env" everytime you want to create a new NFTs. This project is still on-going and we plan to add improvements to this repository.
